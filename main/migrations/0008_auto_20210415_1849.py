    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='main.customer', verbose_name='Покупатьель')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='order',
            field=models.ManyToManyField(related_name='orders', to='main.Order', verbose_name='Заказы покупателя'),
        ),
    ]
