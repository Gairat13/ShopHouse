...
from main.models import NoteBook, SmartPhone, Category, LatestProduct, Customer, Cart, CartProduct
...
class BaseView(CartMixin,View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        products = LatestProduct.objects.get_products_for_main_page('notebook',
                                                                    'smartphone',
...
class ChangeQTYView(CartMixin, View):
    def post(self, request, *arg, **kwargs):
        ...
        cart_product.save()
        self.cart.save()
        messages.add_message(request, messages.INFO, f"Вы изменили кол-во {cart_product.content_object.title} на {qty}")
        return HttpResponseRedirect('/cart/')
